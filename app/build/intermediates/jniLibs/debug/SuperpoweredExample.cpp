...
void SuperpoweredExample::onLimiterState(bool state) {
...
void SuperpoweredExample::onFxReverbValue(int param, int value) {
    ...
    __android_log_print(ANDROID_LOG_VERBOSE, "SuperpoweredExample", "Param: %i , Value: %0.2f", param,scaleValue);
    reverb->enable(true);
    switch(param){
        case REVERB_DRY:
...
extern "C" JNIEXPORT void Java_com_superpowered_crossexample_MainActivity_startRecord(JNIEnv * javaEnvironment, jobject __unused obj, jstring path){
    example->startRecord(javaEnvironment,path);
}

extern "C" JNIEXPORT void Java_com_superpowered_crossexample_MainActivity_onFxReverbValue(JNIEnv * __unused javaEnvironment, jobject __unused obj,jint param, jint value){
    example->onFxReverbValue(param,value);
}

extern "C" JNIEXPORT void Java_com_superpowered_crossexample_MainActivity_onLimiterOpenClose(JNIEnv * __unused javaEnvironment, jobject __unused obj, jboolean state) {
